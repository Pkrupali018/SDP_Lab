...
// class Student {
//   Student({firstName = 'Krupali', lastname = 'Pipaliya', grade = 0})
//       : this.firstName = 'Krupali',
//         this.lastName = 'Pipaliya',
//         this.grade = 100;
...
//   */
//   /*
//   final jb = User(id:1,name:'Poojan');
//   final map = {'id':10,'name':'Pooja'};
...
//   // Challanges:
//   // Challange 1:
//   final Student bert = Student(firstName: 'Kishu', grade: 95);
//   final Student ernie = Student(firstName: 'Krupali', grade: 85);
//   // Challange 2:
