...
void main(List<String> arguments) {
  ...
  */
  ...
  const desserts = [
    ...
    'Bread',
    'Pizza'
  ]; //This is same as , final desserts = const['Milk','Bread','Pizza'];
  // Below 3 will not work because list is const
  // desserts.add('vanilla');
  // desserts.remove('Milk');
  // desserts[0] = 'abc';
...
/*
  ...
  // Challenge 3:
  User user1 = User(1, 'Kishu');
  User user2 = User(2, 'Krupali');
  User user3 = User(3, 'Aaru');
  List<User> users = [Kishu, Krupali, Aaru];
