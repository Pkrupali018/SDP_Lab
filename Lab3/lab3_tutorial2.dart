...
/*
  ...
  // Local variable 'compliment' can't be referenced before it is declared.
  ...
  // helloPersonAndPet(); //2 positional argument(s) expected, but 0 found.
  ...
  // optional parameters --> default value for opetional parameter iis null
  ...
  // print(fullName("Krupali","Pipaliya"));
*/
...
*/
  ...
  */
  ...
  const people = ['Kishu', 'Krupali', 'Aaru'];
  people.forEach((p)){
